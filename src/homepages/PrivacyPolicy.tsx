    ...
    <div className="font-sans bg-white text-[#363636] min-h-screen selection:bg-[#536186]/20">
      ...
      <header className="relative py-20 px-6 border-b border-[#C0C0C0] overflow-hidden bg-[#D3D3D3]">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          ...
          <p className="text-[#363636]/60 font-mono text-sm">
      ...
      <main className="container mx-auto max-w-4xl py-16 px-6 leading-relaxed">
        ...
        <AnimatedSection className="mb-16">
          <p className="text-lg text-[#363636]/80 mb-6 font-medium">
            <span className="text-[#363636] font-bold">Adswise Marketing</span>{" "}
            (“we,” “our,” “us”) values your trust and is committed to protecting
            your privacy. This Privacy Policy explains how we collect, use,
            disclose, and safeguard your information when you visit our website{" "}
            <a
              href="https://www.adswisemarketing.com"
              className="text-[#536186] font-bold hover:underline"
            >
              www.adswisemarketing.com
            </a>
            , use our services, or interact with us through digital platforms,
            advertisements, forms, emails, or communication channels.
          </p>
        ...
        <AnimatedSection className="mb-12">
          ...
          <p className="mb-6 text-[#363636]/80 font-medium">
            We may collect personal and non-personal information in various
            ways, including when you visit our website, fill out a form, request
            a service, or communicate with us.
          </p>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#D3D3D3]/30 p-6 rounded-2xl border border-[#C0C0C0]">
              <h3 className="text-[#536186] font-bold mb-3">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <AnimatedSection className="bg-[#D3D3D3]/30 p-8 rounded-3xl border border-[#C0C0C0]">
            ...
            <h2 className="text-xl font-bold text-[#363636] mb-4">
              3. Cookies & Tracking
            </h2>
            <p className="text-sm text-[#363636]/80 font-medium">
              We use cookies to understand behavior, measure traffic, and
              improve content. You can disable cookies in your browser, though
              it may affect functionality.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection className="bg-[#D3D3D3]/30 p-8 rounded-3xl border border-[#C0C0C0]">
            ...
            <p className="text-sm text-[#363636]/80 font-medium">
              We use tools like Google Analytics, Google Ads, Meta Ads, and
              LinkedIn Ads. These platforms collect data per their own privacy
              policies.
            </p>
          </AnimatedSection>
        </div>
        ...
        <div className="space-y-6 mb-12">
          <AnimatedSection className="bg-white p-6 rounded-xl border border-[#C0C0C0] shadow-sm">
            <h2 className="text-lg font-bold text-[#363636] mb-2">
              5. Data Sharing and Disclosure
            </h2>
            <p className="text-sm text-[#363636]/80 font-medium">
              Information is shared only with trusted service providers, when
              required by law, or with client consent. All third parties must
          ...
          <AnimatedSection className="bg-white p-6 rounded-xl border border-[#C0C0C0] shadow-sm">
            ...
            <p className="text-sm text-[#363636]/80 font-medium">
              ...
              unauthorized access. Note that no internet transmission is 100%
              secure.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection className="bg-white p-6 rounded-xl border border-[#C0C0C0] shadow-sm">
            <h2 className="text-lg font-bold text-[#363636] mb-2">
              7. Client and Business Information
            </h2>
            <p className="text-sm text-[#363636]/80 font-medium">
              All confidential business data shared during strategy discussions
              is treated as strictly confidential. NDAs may be executed where
              required.
            </p>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection className="grid md:grid-cols-2 gap-12 mb-16 border-t border-[#C0C0C0] pt-12">
          <div className="space-y-8">
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <ExternalLink size={18} className="text-[#536186]" /> 8.
                Third-Party Links
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
                We are not responsible for the privacy practices of external
                sites linked on our website.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <Mail size={18} className="text-[#536186]" /> 9. Marketing
                Communication
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
                You may opt out of marketing emails or offers at any time by
                following unsubscribe instructions.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <UserCheck size={18} className="text-[#536186]" /> 10.
                Children’s Privacy
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <Trash2 size={18} className="text-[#536186]" /> 11. Your Rights
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
                You have the right to request access, correction, or deletion of
                your data, or withdraw consent.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <Clock size={18} className="text-[#536186]" /> 12. Data
                Retention
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
            ...
            <div>
              <h3 className="font-bold text-[#363636] flex items-center gap-2 mb-2">
                <FileText size={18} className="text-[#536186]" /> 13. Policy
                Changes
              </h3>
              <p className="text-sm text-[#363636]/80 font-medium">
                We reserve the right to update this policy at any time. Updates
