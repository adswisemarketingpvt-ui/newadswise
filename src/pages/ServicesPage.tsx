...
//       description:
//         "Comprehensive marketing strategies tailored to your business goals and target audience.",
//       features: [
//         "Market Analysis",
//         "Competitor Research",
//         "Goal Setting",
...
//       description:
//         "Improve your search rankings and drive organic traffic with proven SEO techniques.",
//       features: [
//         "Keyword Research",
//         "On-Page SEO",
//         "Link Building",
...
//       description:
//         "Create compelling content that engages your audience and builds brand authority.",
//       features: [
//         "Content Strategy",
//         "Blog Writing",
//         "Video Production",
...
//       description:
//         "Maximize ROI with targeted paid advertising campaigns across multiple platforms.",
//       features: [
//         "Google Ads",
//         "Facebook Ads",
//         "Campaign Management",
...
//       title: "Social Media",
//       description:
//         "Grow your brand presence and engagement across all major social platforms.",
//       features: [
//         "Content Creation",
...
//         <section id="how-we-help" aria-labelledby="how-we-help-title">
//           <div className="hw-container">
//             <h2 id="how-we-help-title">How We Help You Grow</h2>
//             <p className="hw-lead">
//               At <strong>Adswise Marketing</strong>, we don’t just run campaigns — we craft smart, data-driven strategies that breathe life into your brand. Every solution we create is tailored to your business goals, market position, and audience behavior.
//             </p>
...
//               >
//                 <svg className="hw-icon" viewBox="0 0 24 24" aria-hidden="true">
//                   <circle
//                     cx="12"
//                     cy="12"
//                     r="8"
...
//                   className="bg-gray-800 rounded-xl shadow-lg p-8 hover:shadow-2xl transition-shadow duration-300"
//                 >
//                   <div className="w-14 h-14 bg-[#C7843B] rounded-lg flex items-center justify-center mb-6">
//                     <service.icon className="w-7 h-7 text-white" />
//                   </div>
//                   <h3 className="text-2xl font-bold mb-4 text-[#F3BD68]">
//                     {service.title}
//                   </h3>
